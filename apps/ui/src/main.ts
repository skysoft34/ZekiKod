...
app.whenReady().then(async () => {
  // Ensure userData path is consistent across dev/prod so files land in ZekiKod dir
  try {
    const desiredUserDataPath = path.join(app.getPath('appData'), 'ZekiKod');
