  ...
  const sections: WikiSection[] = [
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            <strong className="text-foreground">ZekiKod</strong> is an autonomous AI development
            studio that helps developers build software faster using AI agents.
          </p>
          <p>
            At its core, ZekiKod provides a visual Kanban board to manage features. When you're
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>ZekiKod is built as a monorepo with two main applications and shared libraries:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Here's what happens when you use ZekiKod to implement a feature:</p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-3">The ZekiKod codebase is organized as follows:</p>
...
`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>The main UI components that make up ZekiKod:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            ZekiKod stores project configuration in the{' '}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Follow these steps to start building with ZekiKod:</p>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Learn how ZekiKod works and how to use it effectively
            </p>
          </div>
