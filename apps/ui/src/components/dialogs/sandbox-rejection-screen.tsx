      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            You declined to accept the risks of running ZekiKod outside a sandbox environment.
          </p>
        </div>

        <p className="text-sm text-muted-foreground">
          For safer operation, consider running ZekiKod in Docker. See the README for
          instructions.
        </p>
