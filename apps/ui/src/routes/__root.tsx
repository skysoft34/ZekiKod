      ...
      try {
        ...
        if (!currentProject || currentProject.id !== autoOpenCandidate.id) {
          upsertAndSetCurrentProject(
            ...
            autoOpenCandidate.theme as any
          );
        }
  ...
  return (
    <>
      <main className="flex h-screen overflow-hidden" data-testid="app-container">
        ...
        <div
          className={`fixed top-0 right-0 h-full w-[250px] bg-background border-l border-border transition-transform duration-300 ${streamerPanelOpen ? 'translate-x-0' : 'translate-x-full'
            }`}
        />
        <Toaster richColors position="bottom-right" />
        <VoiceAssistant />
